...
export const lightGreenTheme = {
	"colors": {
		"primary": "rgb(38, 108, 43)",
		"onPrimary": "rgb(255, 255, 255)",
		"primaryContainer": "rgb(170, 245, 164)",
...
export const darkGreenTheme = {
	"colors": {
		...
		"onPrimary": "rgb(0, 57, 11)",
		"primaryContainer": "rgb(4, 83, 21)",
		"onPrimaryContainer": "rgb(170, 245, 164)",
		"secondary": "rgb(185, 204, 179)",

...
export const BrowseTemplate = ({ navigation }) => {
    ...
    const [likePath, setLikePath] = useState('../../assets/heart.png')
    ...
    return (
        <BrowseTemplateNameView plantName={plantNames} tempDetailPress={tempDetailPress} plantLight={plantLight} plantMoisture={plantMoisture} templatesData={templatesData} isFilled={isFilled} setIsFilled={setIsFilled} likePath={likePath} setLikePath={setLikePath} />
    )

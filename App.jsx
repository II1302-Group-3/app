...
import { BrowseTemplateView } from './components/BrowseTemlates/BrowseTemplateView';
			...
			<NavigationContainer theme={navigationTheme}>
				<Stack.Navigator initialRouteName="Home">
					{isLoggedIn ? (
						...
						<Stack.Screen name="BrowseTemplateView" options={{ title: "Browse Template View" }} component={ BrowseTemplateView } />
